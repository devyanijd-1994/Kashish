...
var t = setInterval(function(){
    ...
    // ── KYC COMPLETED → wait screen then sign-process ──
    ?>
<!DOCTYPE html>
<html>
<head>
...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/css/bootstrap.min.css">
<meta http-equiv="refresh" content="3;url=https://kashishweb.questdigiflex.in/sign-process.php?record_id=<?= $record_id ?>">
<style>
body{background:#f0f4ff;display:flex;align-items:center;justify-content:center;min-height:100vh;margin:0}
.box{background:#fff;border-radius:16px;padding:50px 40px;text-align:center;box-shadow:0 4px 20px rgba(0,0,0,.1);max-width:460px;width:100%}
.spinner-ring{width:56px;height:56px;border:5px solid #e0e7ff;border-top-color:#1a3c7a;border-radius:50%;animation:spin 0.9s linear infinite;margin:0 auto 20px}
...
<div class="box">
    ...
    <h5 class="font-weight-bold text-dark mb-2">KYC Verified Successfully!</h5>
    <p class="text-muted mb-1" style="font-size:14px;">
        Please wait while we prepare your agreement for signing.
    </p>
    <p class="text-muted" style="font-size:13px;">
        <strong>Do not close or refresh this page.</strong>
    </p>
    <div class="mt-3" style="font-size:12px;color:#aaa;">Redirecting in 3 seconds...</div>
</div>
</body>
</html>
    <?php
