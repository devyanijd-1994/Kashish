    ...
    <section style={{ 
      ...
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          /* Stack methodology steps vertically on mobile */
          .methodology-step {
          ...
          .methodology-step .step-card {
            max-width: 100% !important;
            margin: 0 !important;
          }
          
          .methodology-step .step-card h4,
          .methodology-step .step-card p {
            text-align: center !important;
          }
          ...
          .methodology-step .step-icon::after {
