...
function OurClientsProfit() {
  ...
  const handlePrev = () => {
    goTo((currentIndex - 1 + clientProfits.length) % clientProfits.length);
  };

  const handleNext = () => {
    goTo((currentIndex + 1) % clientProfits.length);
  };
  ...
  return (
    <section
      ref={sectionRef}
      style={{
        background: 'linear-gradient(160deg, #0a0f2e 0%, #031031 60%, #0d1a4a 100%)',
        minHeight: '100vh',
        display: 'flex',
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ fontSize: '0.72rem', color: '#22c55e', fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase' }}>
              Live Results
            </span>
          </div>
          <h2 style={{
          ...
          <p style={{ fontSize: '0.88rem', color: 'rgba(255,255,255,0.55)', lineHeight: 1.5, margin: 0 }}>
        ...
        >
          ...
          <div style={{
            ...
            borderRadius: '16px',
            overflow: 'hidden',
            boxShadow: '0 16px 50px rgba(34,197,94,0.2), 0 0 0 2px rgba(34,197,94,0.3)',
            background: '#111827',
            height: 'clamp(260px, calc(100vh - 240px), 520px)'
          }}>
            <img
              key={currentIndex}
              src={clientProfits[currentIndex]}
              alt={`Client Profit ${currentIndex + 1}`}
              style={{
                width: '100%',
                height: '100%',
                display: 'block',
            ...
            <div style={{
              ...
              padding: '0.8rem 1rem',
              background: 'linear-gradient(to top, rgba(3,16,49,0.92) 0%, transparent 100%)',
              display: 'flex', alignItems: 'center', justifyContent: 'space-between'
            }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                <div style={{
                  width: '7px', height: '7px', borderRadius: '50%',
                  background: '#22c55e', animation: 'livePulse 1.5s infinite', flexShrink: 0
                }} />
                <span style={{ color: '#fff', fontSize: '0.78rem', fontWeight: 600 }}>
                  Verified Profit Screenshot
                </span>
              </div>
              <span style={{
                background: 'linear-gradient(135deg, #22c55e, #16a34a)',
          ...
          <div style={{
            ...
            borderRadius: '2px', marginTop: '0.6rem', overflow: 'hidden'
          }}>
            <div
              key={currentIndex}
              style={{
                ...
                borderRadius: '2px',
                animation: isPaused ? 'none' : 'progressBar 3s linear forwards'
              }}
            />
          </div>
        </div>
