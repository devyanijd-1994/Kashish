...
function getUserLocation() {
    ...
    // Suppress warnings and handle errors if file_get_contents fails
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO stocktips (name, phone, email, segment, location, created_at, `from`) 
                            VALUES (?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("sssssss", $name, $phone, $email, $segment, $location, $date_and_time, $from);

    // Assign static value for 'from' field
    $from = 'mobile';
...
<body>
                ...
                <div class="single-slider-two hero-utility">
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-8 col-lg-8">
                                <div class="hero-text">
                                    <h2 class="profess">
                                        ...
                                        with <b>Best Trading & Investment Calls </b> <br />
                                        <br />
                                        <span style="background-image: linear-gradient(Transparent, #80d3a8);"><em>
                                                Research Analyst</em></span>
                                    </h2>
                                    <!-- <h1>Kashish Joshi Research</h1> -->
                                    <h4 class="mt-4">
                                        <img src="assets/images/newimg/Rectangle.png" alt="" />
                                        Get <b> Best Stocks</b> Today for <b>Intraday Trade</b> Tomorrow.
                                    </h4>
                                    <h4 class="mt-4">
                                        <img src="assets/images/newimg/Rectangle.png" alt="" />
                            ...
                            <div class="col-xl-4 col-lg-4" style="margin-top: 60px; padding: 0px;">
                                <div class="hero-form">
                                    ...
                                    <form id="dataForm" action="" method="POST">
                                        ...
                                        <div class="form-group mb-3 form-floating">
                                            <select class="form-control" id="segment" name="segment" required>
                                                <option value="Stock Services - Cash, Future, Option">Bank Nifty/Nifty
                                                    Option</option>
                                        ...
                                        <button type="submit" class="header-cta bttnn p-1"
                                            style="margin-bottom: 10px; padding: 16px;">Start Free Trial</button>
                                    </form>
    ...
    <section class="image-slide1r11">
        ...
        <div class="slide1r1-container1">
            ...
            <div class="slide1r1" style="transform: translateX(0%);">
                <div class="slide1">
                    <img src="./assets/images/newimg/scrennshot1.png" alt="Screenshot 1">
                </div>
                <div class="slide1">
                    <img src="./assets/images/newimg/screenshot2.png" alt="Screenshot 2">
                </div>

                <div class="slide1">
                    <img src="./assets/images/newimg/screenshot3.png" alt="Screenshot 2">
                </div>
                <div class="slide1">
                    <img src="./assets/images/newimg/screenshot4.png" alt="Screenshot 2">
                </div>
                <div class="slide1">
                    <img src="./assets/images/newimg/scrennshot5.png" alt="Screenshot 2">
                </div>
                <div class="slide1">
                    <img src="./assets/images/newimg/screenshot6.png" alt="Screenshot 2">
                </div>
                <div class="slide1">
                    <img src="./assets/images/newimg/screenshot7.png" alt="Screenshot 2">
                </div>
                <!-- <div class="slide1">
        ...
        <div class="dot1111s-container1">
            <span class="dot1111 active" onclick="currentslide1(0)"></span>
    ...
    <div style="text-align: center; align-items: center; justify-content: center; margin-top: 40px;">
        <!-- https://api.whatsapp.com/send?phone=919171718451&text=Book%20My%20Trading%20Slot -->
                        ...
                        <div>
                            ...
                            <div style="margin-top: 4px; margin-bottom: 30px; ">
                                <div style="text-align: center; align-items: center; justify-content: center;">
                                    <button class="blink-button"><a
                                            href="https://api.whatsapp.com/send?phone=919171718451&text=Book%20My%20Trading%20Slot">Enroll
                                            Now</a> </button>
                                </div>
                            </div>
        ...
        <div class="col-lg-6">
          <div class="about-content">
            <div class="section-title">
              <div class="sub-heading">
               <p>
                  ...
                  <img src="assets/images/newimg/arrow.png" width="20px" alt="" />
                </p>
              </div>
              <h2 class="Change">
                Change Your 
            ...
            <br>
              ...
              <button style="border-radius: 40px; padding: 10px; border: 1px solid #313493; background-color: #fff;">
              ...
              <div class="col-lg-6 col-md-12">
                <div class="row">
                  <div class="col-md-6 col-lg-12 mb-4">
                    <div class="card"
                      style="border-radius: 20px; box-shadow: rgba(17, 17, 26, 0.05) 0px 0px 0px, rgba(17, 17, 26, 0.05) 0px 8px 12px; margin-top: 40px;">
                      <div class="card-body">
                                                    ...
                                                    <form id="dataForm" action="" method="POST">
                                                        ...
                                                        <div style="margin-left: 10px; margin-right: 10px;">
                                                            ...
                                                            <div class="form-group mb-3 form-floating">
                                                                ...
                                                                <!-- <label for="segment" style="margin-left: 15px;">Select Your Segment</label> -->
                                                            </div>
                                                            <div class="row">
                        ...
                        <div class="card crd">
                            <div class="">
                                <h5 class="card-title"
                                    ...
                                    Nifty/ <br>
                                    Nifty Future</h5>
                                <!-- <p style="text-align: center; background-color: #303393; width: 100%;  ">Starting From <br> <span>₹ 4,999/</span></p> -->
                                                            ...
                                                            <div class="form-group mb-3 form-floating">
                                                                <select class="form-control" id="segment" name="segment"
                                                                    ...
                                                                    <option value="Advance Trading Plan (ATP) Services">
                                                                        Bank Nifty/
                                                                        Nifty Future</option>
                                                                    <option value="Commodity Services">Stock
                                                                        Commodity</option>
                                                                    <option value="Commodity Services">Stock F&O
                                                                    </option>
                                                                    <option value="Commodity Services">Systematic
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        ...
                        <h2 class="invest"
                            style="text-align: center; color: #454040; font-size: 20px; margin-bottom: 20px; margin-top: 10px;">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="widget">
                        <a href="index">
                            ...
                            <div style="background-color: #fff; width: 180px; border-radius: 10px;">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 d-center">
                    <div class="widget w-text">
                        ...
                        <ul>
                            ...
                            <li><a href="https://kashishjoshiresearch.com/stocktips-m/"
