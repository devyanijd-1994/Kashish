          ...
          <div style={{ 
            ...
            <div style={{
              ...
              <h2 className="heading-lg" style={{ 
                ...
                Leading Financial Markets with <span className="gradient-text">Proven Excellence</span>
              </h2>
              ...
              <p className="body-text" style={{ 
                ...
                Kashish Joshi Research has established itself as one of India's most trusted financial advisory firms since our inception. With over 8 years of dedicated service in the financial markets, we have built a reputation for delivering exceptional results through our advanced research methodologies and professional trading strategies.
              </p>
              ...
              <p className="body-text" style={{ 
                ...
                Our success is built on a foundation of rigorous market analysis, cutting-edge technology, and an unwavering commitment to our clients' financial growth. We don't just provide trading signals; we empower our clients with the knowledge and tools needed to navigate the complex world of financial markets successfully.
              </p>
              ...
              <div style={{
                ...
                <div style={{ textAlign: 'center', position: 'relative', zIndex: 1 }}>
                  ...
                  <p style={{
                    ...
                    "With 8+ years of market experience and a proven track record of 80-90% success rates, I'm committed to helping traders achieve consistent profitability through disciplined research and strategic market analysis."
                  </p>
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      <div style={{ fontSize: 'var(--font-size-lg)', fontWeight: 700 }}>8+</div>
                      <div style={{ fontSize: 'var(--font-size-xs)', opacity: 0.9 }}>Years</div>
                    </div>
                    <div style={{
                      ...
                      <div style={{ fontSize: 'var(--font-size-lg)', fontWeight: 700 }}>85%</div>
                      <div style={{ fontSize: 'var(--font-size-xs)', opacity: 0.9 }}>Success</div>
                    </div>
                  </div>
                </div>
              </div>
